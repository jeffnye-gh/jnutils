...
CommandMap command_map = {
    {"help",      [this](tcp::socket& s, ArgsType& args) { handle_help(s, args); }},
    {"?",         [this](tcp::socket& s, ArgsType& args) { handle_help(s, args); }},
    {"sendblock", [this](tcp::socket& s, ArgsType& args) { handle_sendblock(s, args); }},
    {"set",       [this](tcp::socket& s, ArgsType& args) { handle_set(s, args); }},
    {"show",      [this](tcp::socket& s, ArgsType& args) { handle_show(s, args); }},
};
// =====================================================================
// HHH
// =====================================================================
...
// Example block data
// ---------------------------------------------------------------------
void handle_sendblock(tcp::socket &socket,ArgsType&) {
  string block =
